...
export default function LogHistory({ logs, activeDate, logsLoading, logsError, reload, showToast, requestConfirm }) {
    ...
    return (
        <div className="diary-card" style={{ marginTop: '25px' }}>
            ...
            {logsLoading ? (
                ...
                <div style={{ padding: '12px', background: '#FEF2F2', borderRadius: 8, color: '#991B1B', fontSize: 13 }}>
                    {logsError}
                    <button
                        onClick={reload}
